...
CREATE TABLE IF NOT EXISTS db_biblioteca.SOCIOS (
  socio_clave INT(10) NULL AUTO_INCREMENT,
  socio_nombre VARCHAR(45) NULL,
  socio_direccion VARCHAR(45) NULL,
  socio_categoria VARCHAR(45) NULL,
  socio_telefono VARCHAR(10) NULL,
  socio_pass VARCHAR(200) NULL,
  socio_estado TINYINT NULL,
